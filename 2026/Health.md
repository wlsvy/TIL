...
![image_2025-04-24-18-48-11](img/image_2025-04-24-18-48-11.png)
...
![image_2025-04-24-19-19-58](img/image_2025-04-24-19-19-58.png)
...
## [고도근시 필수 시청!👀 눈 덜 작아보이게 하는 안경 고르기 팁😲](https://www.youtube.com/watch?v=GHyKMSwaRi4)

공유해주신 영상은 **고도근시인 분들이 안경을 썼을 때 눈이 덜 작아 보이게 하는 방법**에 대한 실용적인 팁을 담고 있습니다. 

### 1. 안경테 선택 가이드

* **사이즈 최소화:** 근시 렌즈는 가장자리로 갈수록 두꺼워집니다. 테 사이즈가 작을수록 렌즈의 얇은 중심부만 사용하게 되어 눈이 덜 작아 보이고 왜곡도 줄어듭니다 [[01:43](http://www.youtube.com/watch?v=GHyKMSwaRi4&t=103)].
* **눈동자 위치 확인:** 까만 눈동자가 안경테의 중앙에 위치하는 것이 가장 안정적입니다. 눈동자와 안경테 각 모서리 사이의 간격이 비슷한 제품을 선택하세요 [[02:42](http://www.youtube.com/watch?v=GHyKMSwaRi4&t=162)].
* **피해야 할 모양:** 렌즈와 눈 사이의 거리가 먼 디자인이나, 좌우로 너무 긴 모양은 렌즈 두께를 증가시키고 주변부 왜곡을 심화시킵니다 [[03:04](http://www.youtube.com/watch?v=GHyKMSwaRi4&t=184)].
* **소재와 거리:** 안경이 눈에 가까울수록 눈이 덜 작아 보입니다. 코받침이 없는 뿔테가 유리할 수 있으나, 착용감을 고려해 눈과 너무 떨어지지 않게 조절 가능한 제품을 고르는 것이 좋습니다 [[03:54](http://www.youtube.com/watch?v=GHyKMSwaRi4&t=234)].

### 2. 안경 렌즈 선택 및 가공

* **굴절률(압축):** 고도근시라면 가장 얇게 제작 가능한 **1.74 굴절률** 렌즈를 추천합니다. 1.67 렌즈와 비교했을 때 가장자리 두께가 약 1mm 정도 줄어들어 외관상 차이가 큽니다 [[04:41](http://www.youtube.com/watch?v=GHyKMSwaRi4&t=281)].
* **렌즈 설계:** 구면보다는 비구면, 더 나아가 **양면 비구면 설계**가 눈이 작아 보이는 현상과 옆면이 움푹 들어가 보이는 왜곡을 줄여줍니다 [[06:09](http://www.youtube.com/watch?v=GHyKMSwaRi4&t=369)].

---

### 1. 근시(Myopia)란?

근시는 우리가 물체를 바라볼 때 그 상이 망막의 정확한 위치에 맺히지 못하고, **망막 앞쪽에 결상**되는 눈의 상태를 말합니다. 이로 인해 가까운 곳은 잘 보이지만 멀리 있는 사물은 흐릿하게 보이게 됩니다.

### 2. 디옵터(Diopter)와 고도근시

디옵터는 안경 렌즈의 굴절력을 나타내는 단위입니다.

* **고도근시의 기준:** 학회에서는 보통 **-5.25 디옵터 이상**을 고도근시로 분류합니다.
* 하지만 최근에는 시력이 좋지 않은 사람들이 워낙 많아져서, 실제 현장에서는 이보다 더 높은 수치를 가진 분들을 고도근시라고 부르기도 합니다.

### 3. 근시 교정 렌즈의 특징

근시를 교정하는 오목렌즈는 구조적인 특징 때문에 안경을 썼을 때 외관상 변화가 생깁니다.

* **렌즈 두께:** 중심부는 얇고 **가장자리로 갈수록 두꺼워지는 구조**입니다. 이 때문에 안경테 밖으로 렌즈가 튀어나와 보일 수 있습니다.
* **배율 현상:** 마이너스 렌즈의 특성상 사물의 크기를 실제보다 작게 만듭니다. 고도근시인 분들이 안경을 썼을 때 **눈이 작아 보이고 얼굴 라인이 왜곡**되어 보이는 이유가 바로 이 배율 때문입니다.

---

스마트폰이나 PC를 과도하게 사용할 때 **안구가 앞뒤로 길어져서 근시가 생긴다**는 말은 현대 의학적으로 **매우 타당한 설명**입니다. 이를 '축성 근시'라고 부르는데, 구체적인 원리와 과정을 정리해 드릴게요.

### 1. 안구가 길어지는 이유 (축성 근시)

정상적인 눈은 원형에 가깝지만, 근시가 진행되면 안구의 앞뒤 길이(안축장)가 럭비공처럼 길어집니다.

* **조절 긴장:** 가까운 화면을 오랫동안 집중해서 보면 눈 안의 근육(모양체근)이 수정체를 두껍게 만들기 위해 계속 수축 상태를 유지합니다.
* **안구 신장:** 특히 성장기 아이들의 경우, 가까운 곳을 계속 보려는 시각적 자극에 적응하기 위해 안구 자체가 뒤로 늘어나게 됩니다. 안구가 **1mm만 길어져도 약 -3.00 디옵터 정도의 근시**가 발생할 수 있습니다.

### 2. 왜 스마트폰과 PC가 주범인가?

* **과도한 근거리 작업:** 스마트폰은 독서보다 더 가까운 거리(약 20~30cm)에서 화면을 보기 때문에 눈의 피로도와 조절 부담이 훨씬 큽니다.
* **청색광(블루라이트)과 깜빡임 감소:** 화면에 집중하면 눈을 깜빡이는 횟수가 평소보다 1/3 수준으로 줄어들어 안구 건조증을 유발하고, 이는 시력 저하의 간접적인 원인이 됩니다.

## [(10) 안경 쓸수록 시력이 떨어지는 이유...? 안경사가 솔직히 얘기해드림 [근시, 드림렌즈, 난시, 라섹]](https://www.youtube.com/watch?v=iI1wv4PtFEA&list=WL&index=19)

이 영상은 안경을 쓸수록 시력이 떨어진다는 오해와 성장기 근시 진행의 원인, 그리고 정확한 도수의 안경 착용이 왜 중요한지에 대해 설명하고 있습니다.

### **1. 시력이 계속 떨어지는 진짜 이유**

* **안구의 성장:** 초·중학생 등 성장기에는 키가 크고 머리가 커지면서 안구의 크기도 함께 커집니다 [[01:26](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=86)].
* **근시와 안구 크기:** 안구가 커지면 망막에 맺혀야 할 초점이 앞에 맺히게 되어 근시가 심해지는데, 이는 신체 성장에 따른 자연스러운 현상입니다 [[01:08](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=68)].
* **안경 도수와의 무관함:** 안경 도수를 높인다고 해서 그것 때문에 시력이 더 나빠지는 것은 아니며, 안구 성장이 주된 원인입니다 [[02:03](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=123)].

### **2. 실명 및 안경 착용에 대한 오해**

* **실명 가능성:** 근시가 진행된다고 해서 실명될 가능성은 0%에 가까우므로 과도한 걱정은 하지 않아도 됩니다 [[01:54](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=114)].
* **도수 교체의 필요성:** 시력이 떨어질 때마다 안경 도수를 맞춰줘야 하는 이유는 단순히 잘 보이기 위해서만이 아닙니다.

### **3. 정확한 도수의 안경을 써야 하는 이유**

* **약시 예방:** 잘 안 보이는 상태로 방치하면 뇌가 선명함을 인식하지 못해 나중에 도수를 높여도 시력이 올라가지 않는 '약시'가 될 수 있습니다 [[02:54](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=174)]. 이를 방지하기 위해 교정 시력을 0.9~1.0 정도로 유지해 주는 것이 중요합니다 [[03:36](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=216)].
* **학습 능력 및 집중력:** 시력이 맞지 않으면 눈을 찡그려 보게 되어 피로가 쌓이고 집중력이 저하됩니다 [[04:13](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=253)]. 시각 정보는 뇌로 전달되는 정보의 큰 비중을 차지하므로 올바른 시력 교정은 지능 발달과 직결됩니다 [[04:36](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=276)].

따라서 성장기에는 6개월에서 1년 주기로 정기적인 검사를 통해 눈 상태에 맞는 안경 렌즈로 교체해 주는 것이 권장됩니다 [[04:04](http://www.youtube.com/watch?v=iI1wv4PtFEA&t=244)].

# 26.04.15

## [윌스기념병원 수원 - 토마스의료재단](https://allspine.com/info/info03.html?jb_code=70&jb_idx=16180&search_key=&search_keyword=&page=2)

- **수면 관성**

코로나19로 인해 많은 회사에서 실시하던 재택근무가 줄어들고, 회사로 출근하는 이들이 많아졌다. 지각해서 상사의 눈치를 보거나 소중한 급여가 줄지 않도록 아침 알람을 이중삼중으로 맞추고 잠을 잔다. 아침에 알람을 몇차례 끄고, 어느정도 뒤척이고 나서야 눈을 제대로 뜨지도 못한 채 무거운 몸을 이끌고 씻으러 간다.

요즘 직장인들의 모습일 것이다. 특별히 무리를 하지 않는데도 불구하고 매일 졸리고 피곤하다. 때문에 알람을 매분 마다 혹은 5분마다 몇 차례씩 맞춰 놓는 경우가 많은데, 이러한 습관이 우리를 더 피곤하게 만든다. 실제 하버드대 오퓨 벅스턴 교수의 연구에 따르면 알람을 듣고 일어나 끄고 다시 잠드는 사람들은 피로감 유발 물질인 아데노신 호르몬이 분비되어 수면의 질이 떨어지고, 이것이 반복되면 오히려 피로를 누적시켜 만성피로로 이어질 수 있다고 밝혔다.

이를 ‘수면 관성(Sleep Inertia)’이라고 한다. 수면 관성은 자다가 일어난 뒤 한동안 잠에서 깨지 못하고 비몽사몽 한 상태를 말한다. ‘관성’은 물리학에 나오는 용어로 어떤 물체가 외부로부터 힘을 받지 않을 때 처음의 운동 상태를 계속 유지하려는 성질이다. 정지해 있는 물체는 정지상태를 계속 유지하려 하고, 운동하고 있는 물체는 계속 운동을 하려는 성질이다. ‘수면 관성’은 계속 잠을 자려는 성질로, 일어났지만 자는 것처럼 가수면 상태가 이어지는 것이다. 이런 졸린 상태는 1분에서 길게는 2시간까지 지속된다.

알람을 여러 차례 맞춰 놔서 자다 깨다를 반복하면 수면 관성 시간이 길어져 더욱 피곤해진다. 잠에서 깰 때엔 뇌가 코르티솔과 도파민과 같은 각성 호르몬을 분비해 몸을 깨운다. 그렇지만 곧장 알람을 끄고 다시 누우면 졸음을 유발하는 아데노신 호르몬이 분비된다. 이렇게 되면 짧은 순간에 호르몬의 급변함이 반복되면서 잠을 깨기가 더욱 어렵고, 얕은 잠을 자게 되면서 만성피로로 이어질 수 있는 것이다.

수면 관성은 낮잠과도 연관이 있다. 낮잠을 오래 자면 오히려 몽롱할 때가 있다. 이를 예방하기 위해서는 호르몬(아데노신)이 뇌와 몸을 지배하기 전에 얼른 깨는 것이 좋다. 즉, 낮잠을 30분 이상 자지 않도록 해야한다.

만성피로를 예방하고 수면장애를 막기 위해선 수면 리듬을 유지하는 것이 중요하다. 정해진 시각에 잠들고 깨도록 하며, 알람 소리가 크게 울리도록 한 번만 설정한 후 알람이 울리면 바로 일어나야 잠을 깨기 쉽다.

알람을 한 개만 맞추는 것이 불안하다면 알람 사이의 간격을 넓게 설정하고, 점차 그 개수를 줄여나가도록 한다. 또한 알람 소리를 주기적으로 변경해 익숙함에 인지하지 못하는 상황을 대비해야 한다. 일어나자마자 커튼을 열어 햇빛을 쬐면 잠에서 깨는데 도움이 되고, 잠에서 깬 지 1시간 이내에 식사를 하면 인지기능 향상에 도움을 줄 수 있다.
